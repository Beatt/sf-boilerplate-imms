...
Encore
  ...
  .addEntry('editar-pagos', './assets/js/institucion_educativa/EditarPagoFofoe/index.js')
  .addEntry('registrar-factura', './assets/js/institucion_educativa/RegistrarFactura/index.js')
