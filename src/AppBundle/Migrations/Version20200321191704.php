...
class Version20200321191704 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE usuario (id SERIAL NOT NULL, usuario VARCHAR(25) NOT NULL, contrasena VARCHAR(64) NOT NULL, correo VARCHAR(254) NOT NULL, es_activo BOOLEAN NOT NULL, PRIMARY KEY(id))');
