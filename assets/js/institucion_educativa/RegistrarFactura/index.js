...
const Registrar = (
  {
    ...
    const hangleChecked = (event) => {
        let subtotal = total;
        if(event.checked)
            subtotal += parseInt(solicitud.pagos[event.id].monto);
        else
            subtotal -= parseInt(solicitud.pagos[event.id].monto);
  ...
  return (
    <form
        action={`/instituciones/${institucion.id}/solicitudes/${solicitud.id}/registrarFactura`}
        method="post"
        ...
        <div>
            ...
            <div className="row mt-10">
                <div className="col-md-12">
                    ...
                    <p className="mt-10 mb-10">Seleccione los comprobantes de pago que estarán asociados a la factura a emitir.</p>
                                ...
                                solicitud.pagos.map((item, index) =>
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <input
                                                type="checkbox"
                                                onChange={e => hangleChecked(e.target)}
                                                id={index}
                                            />
                                        </td>
